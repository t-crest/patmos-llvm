...
error_code ELFObjectFile<target_endianness, is64Bits>
  ...
  case ELF::EM_PATMOS:
    switch (type) {
      ...
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_CFLB_ABS);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_CFLB_PCREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_ALUI_ABS);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_ALUI_PCREL);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_ALUL_ABS);
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_ALUL_PCREL);
      ...
      LLVM_ELF_SWITCH_RELOC_TYPE_NAME(R_PATMOS_PCREL_32);
    default:
      res = "Unknown";
    }
    break;
