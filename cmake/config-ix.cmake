...
# check for a program under different names but with a fixed alias
# (the alias name is used for #defines and build variables).
# e.g.: llvm_find_program_alias(xdot.py "xdot.py xdot")
function(llvm_find_program_alias alias)
  string(TOUPPER ${alias} NAME)
  string(REGEX REPLACE "\\." "_" NAME ${NAME})
  string(REPLACE " " ";" NAMES_LIST ${ARGN})
  find_program(LLVM_PATH_${NAME} NAMES ${NAMES_LIST})
  mark_as_advanced(LLVM_PATH_${NAME})
  if(LLVM_PATH_${NAME})
    set(HAVE_${NAME} 1 CACHE INTERNAL "Is one of ${names} available ?")
    mark_as_advanced(HAVE_${NAME})
  else(LLVM_PATH_${NAME})
    set(HAVE_${NAME} "" CACHE INTERNAL "Is one of ${names} available ?")
  endif(LLVM_PATH_${NAME})
endfunction()
...
elseif (LLVM_NATIVE_ARCH MATCHES "patmos")
  set(LLVM_NATIVE_ARCH PATMOS)
