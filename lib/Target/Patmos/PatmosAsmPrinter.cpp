...
// of machine-dependent LLVM code to the Patmos assembly language.
//
//===----------------------------------------------------------------------===//
...
void PatmosAsmPrinter::printOperand(const MachineInstr *MI, int OpNum,
...
bool PatmosAsmPrinter::PrintAsmMemoryOperand(const MachineInstr *MI,
                                             unsigned OpNo, unsigned AsmVariant,
