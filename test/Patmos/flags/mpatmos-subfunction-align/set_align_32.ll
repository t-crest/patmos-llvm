...
;//////////////////////////////////////////////////////////////////////////////////////////////////
;
; Tests that we can change the subfunction alignment to 32 bytes.
;
...
;
; This flag currently doesn't work, therefore, we have set test number 2 to XFAIL so that
; CI still succeeds. When this is fixed, XFAILs should be removed.
;
;//////////////////////////////////////////////////////////////////////////////////////////////////
