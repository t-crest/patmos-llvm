...
; RUN: %p/../assert_singlepath.sh llc "-O2 -mpatmos-disable-vliw=false" %s init_func %DEBUG_TYPE %LINK_LIBS "0 0"=0 "0 1"=2 "1 0"=1 "1 1"=3 "3 2"=7 "10 10"=30
; END.
;//////////////////////////////////////////////////////////////////////////////////////////////////
; 
...
for.cond2:                                        ; preds = %for.inc6, %for.end
  ...
  br i1 %cmp3, label %for.body4, label %for.end8, !llvm.loop !0
