; RUN: %p/../assert_singlepath.sh llc -O2 %s init_func %DEBUG_TYPE %LINK_LIBS 0=0 1=55 2=700 9=4095 10=19500
; RUN: %p/../assert_singlepath.sh llc "-O2 -mpatmos-disable-vliw=false" %s init_func %DEBUG_TYPE %LINK_LIBS 0=0 1=55 2=700 9=4095 10=19500
;//////////////////////////////////////////////////////////////////////////////////////////////////
; 
