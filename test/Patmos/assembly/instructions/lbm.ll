...
entry:  
  ...
  store i8 114, i8* %stack_var_1
  %stack_var_2 = getelementptr inbounds i8* %stack_var_1, i32 2
  store i8 -114, i8* %stack_var_2
  ...
  ; Check correctness
  %correct_1 = icmp eq i32 %result_1, 114
  %correct_2 = icmp eq i32 %result_2, -114
