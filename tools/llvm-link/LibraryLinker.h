...
/// This class provides the functionality of linking with archives. It retains a
...
class LibraryLinker : public Linker {
  ...
  public:
    ...
    LibraryLinker(StringRef progname, ///< name of tool running linker
    ...
    LibraryLinker(StringRef progname, Module* aModule, unsigned Flags = 0);
